...
- translators:
  - ["Nasser Safarinia", "https://github.com/nsafari"]
---

<p dir='rtl'>
سالیدیتی به شما امکان میدهد برروی [اتریوم](https://www.ethereum.org/) برنامه نویسی کنید.
اتریوم یک ماشین مجازی مبتنی بر بلاک چین است که اجازه ی ایجاد و اجرای قراردادهای هوشمند را بدون نیاز به واسطه متمرکز برای ایجاد اطمینان، میدهد.
</p>
